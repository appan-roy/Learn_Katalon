...
WebUI.setText(findTestObject('OrangeHRM_Manual_OR/Page_OrangeHRM/input_LOGIN Panel_txtUsername'), uname)

WebUI.setText(findTestObject('OrangeHRM_Manual_OR/Page_OrangeHRM/input_Username_txtPassword'), pwd)
